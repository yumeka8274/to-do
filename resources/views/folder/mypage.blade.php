        ...
        <div class="relative overflow-hidden shadow-lg rounded-lg" style="padding-top: 100%;">
          ...
          <div class="absolute inset-0 bg-white opacity-0 hover:opacity-75 flex items-center justify-center">
              ...
              <div class="text-center text-white">
                <h2 class="tracking-widest text-5xl title-font font-medium text-indigo-500 mb-1">{{ $folder->title }}</h2>
                <h1 class="title-font text-xs font-medium text-black mb-3">{{ $folder->title }}</h1>
                {{-- <p class="leading-relaxed">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p> --}}
                


                <div class="flex">
                  <button type="button" class="end-2.5 text-white-400  bg-red-500  rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white " data-modal-hide="authentication-modal">
